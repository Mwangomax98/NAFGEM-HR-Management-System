...
-- 7. ENHANCE SECURITY EVENT LOGGING
...
AS $$
BEGIN
  INSERT INTO public.security_events (user_id, event_type, details, ip_address, user_agent)
  VALUES (
    p_user_id, 
    p_event_type, 
    p_details,
...
EXCEPTION
  WHEN OTHERS THEN
    -- Log basic event without network info if that fails
