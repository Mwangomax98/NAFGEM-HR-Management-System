        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 bg-blue-50 dark:bg-blue-950 rounded-lg">
              ...
              <p className="text-2xl font-bold text-blue-700 dark:text-blue-300">324</p>
            ...
            <div className="p-4 bg-red-50 dark:bg-red-950 rounded-lg">
              ...
              <p className="text-2xl font-bold text-red-700 dark:text-red-300">128</p>
            ...
            <div className="p-4 bg-purple-50 dark:bg-purple-950 rounded-lg">
              ...
              <p className="text-2xl font-bold text-purple-700 dark:text-purple-300">67</p>
